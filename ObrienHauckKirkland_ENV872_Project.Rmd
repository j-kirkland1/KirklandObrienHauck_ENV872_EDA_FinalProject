...
and examined concentration trends over time. This time-series plot 
revealed a clear gap in sampling between 1970 and the mid-1990s. 
We plotted a reference line representing the mercury PEC, above
which harmful effects to sediment-dwelling biota are likely to occur.
...
A preliminary summary showed that some concentration results were coded as 
...
The preliminary analysis begins with orienting the viewers to the Penobscot 
...
dataset subset during the original data wrangling. 

Below is a map of mercury concentration, in part per million (PPM) 
as a color gradient in the spatially situated river, with yellow being 
between 0-20 PPM and red being >25 PPM 
